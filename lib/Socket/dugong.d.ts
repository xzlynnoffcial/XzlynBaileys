...
declare namespace XzlynHandler {
...
declare class XzlynHandler {
    constructor(
        utils: XzlynHandler.Utils,
        waUploadToServer: XzlynHandler.WAMediaUploadFunction,
        relayMessageFn?: (jid: string, content: any, options?: any) => Promise<any>
    );

    detectType(content: XzlynHandler.MessageContent): 'PAYMENT' | 'PRODUCT' | 'INTERACTIVE' | 'ALBUM' | 'EVENT' | 'POLL_RESULT' | 'GROUP_STORY' | null;

    handlePayment(
        content: { requestPaymentMessage: XzlynHandler.PaymentMessage },
        quoted?: proto.IWebMessageInfo
    ): Promise<{ requestPaymentMessage: proto.Message.RequestPaymentMessage }>;

    handleProduct(
        content: { productMessage: XzlynHandler.ProductMessage },
        jid: string,
        quoted?: proto.IWebMessageInfo
    ): Promise<{ viewOnceMessage: proto.Message.ViewOnceMessage }>;

    handleInteractive(
        content: { interactiveMessage: XzlynHandler.InteractiveMessage },
        jid: string,
        quoted?: proto.IWebMessageInfo
    ): Promise<{ interactiveMessage: proto.Message.InteractiveMessage }>;

    handleAlbum(
        content: { albumMessage: XzlynHandler.AlbumItem[] },
        jid: string,
        quoted?: proto.IWebMessageInfo
    ): Promise<any>;

    handleEvent(
        content: { eventMessage: XzlynHandler.EventMessage },
        jid: string,
        quoted?: proto.IWebMessageInfo
    ): Promise<any>;

    handlePollResult(
        content: { pollResultMessage: XzlynHandler.PollResultMessage },
        jid: string,
        quoted?: proto.IWebMessageInfo
    ): Promise<any>;

    handleGroupStory(
        content: { groupStatusMessage: XzlynHandler.GroupStatusMessage },
        jid: string,
        quoted?: proto.IWebMessageInfo
    ): Promise<any>;
    ...
    buildMessageContent(
        content: any,
        opts?: XzlynHandler.WAMessageContentGenerationOptions
    ): Promise<any>;

    utils: XzlynHandler.Utils;
    relayMessage: (jid: string, content: any, options?: any) => Promise<any>;
    waUploadToServer: XzlynHandler.WAMediaUploadFunction;
    bail: XzlynHandler.BailUtils;
}
